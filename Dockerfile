...
RUN curl -OL https://github.com/trunk-rs/trunk/releases/download/v0.20.3/trunk-x86_64-unknown-linux-gnu.tar.gz ; tar xf ./trunk-x86_64-unknown-linux-gnu.tar.gz ; mv ./trunk /root/.cargo/bin/trunk
